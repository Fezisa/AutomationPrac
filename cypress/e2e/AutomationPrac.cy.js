describe('AutomationPrac', () => {
  ...
  it('TC2 - Check that selected item is displayed - when partially spelt then selected from the "Suggestion Class" list', () => {
    ...
    // Check "South Africa" is in the textbox
  ...
  it('TC3 - Validate that all checkboxes are checked - when all the checkboxes are checked', () => {
  ...
  it('TC7 - Validate on the Web Table that the Amount = specified number AND matches the Name, Position and City', () => {
  ...
  it('TC8 - Validate on the Web Table that the total amount collected = 296', () => {
  ...
  it('TC9 - Validate that the sum of all the Amounts in the Web Table is correct', () => {
